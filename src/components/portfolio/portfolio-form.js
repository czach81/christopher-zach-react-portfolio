...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://chriszach.devcamp.space/portfolio/portfolio_items",
            apiAction: 'post'
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            url: url || "",
            editMode: true,
            apiUrl: `https://chriszach.devcamp.space/portfolio/portfolio_items/${id}`,
            apiAction: "patch",
  ...
  render() {
    return (
       <form onSubmit= {this.handleSubmit} className="portfolio-form-wrapper">
            ...
            >
                <option value="eCommerce"> Python </option>
                <option value="Scheduling"> JavaScript </option>
                <option value="Enterprise"> React </option>
            </select>
